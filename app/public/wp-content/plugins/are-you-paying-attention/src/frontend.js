        ...
        <div className="paying-attention-frontend" style={{backgroundColor: props.bgColor, textAlign: props.theAlignment}}>
            ...
            <ul>
                {props.answers.map((answer, index) => {
                    return (<li className={(isCorrectDelayed === true && index == props.correctAnswer ? "no-click" : "") + (isCorrect == true && index != props.correctAnswer ? "fade-incorrect" : "") } onClick={isCorrect === true ? undefined : () => handleAnswer(index)}>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" className="bi bi-emoji-smile" viewBox="0 0 16 16">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" className="bi bi-emoji-frown" viewBox="0 0 16 16">
            <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
