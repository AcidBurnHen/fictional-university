    ...
    function wordFilterPage() { ?>
        <div class="wrap">
            ...
            <form method="POST">
                ...
                <label for="plugin_words_to_filter"><p>Enter a <strong>comma-separated</strong> list of words to filter from your sites content</p></label>
...
$ourNewFilterPlugin = new OurWordFilterPlugin();